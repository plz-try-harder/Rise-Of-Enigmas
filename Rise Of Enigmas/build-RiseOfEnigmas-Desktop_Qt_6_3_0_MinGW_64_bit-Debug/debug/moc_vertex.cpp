...
#include <memory>
#include "../../RiseOfEnigmas_src/EulerGraphInteract/vertex.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Vertex_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Vertex_t qt_meta_stringdata_Vertex = {
    {
QT_MOC_LITERAL(0, 6) // "Vertex"
...
const QMetaObject Vertex::staticMetaObject = { {
    ...
    qt_meta_stringdata_Vertex.offsetsAndSize,
    qt_meta_data_Vertex,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Vertex_t
, QtPrivate::TypeAndForceComplete<Vertex, std::true_type>
